...
# -----------------------------------------------------------------------------
# VNet Configuration (Enterprise Networking)
# -----------------------------------------------------------------------------
variable "vnet_config" {
  description = "Virtual Network configuration for enterprise networking"
  type = object({
    name          = string
    ...
    subnets = object({
      ...
      bastion_cidr      = optional(string, null)
    })
...
variable "deploy_networking" {
  description = "value to determine if networking module should be deployed"
  type        = string
  default     = "false"
}
